...
class CupScorerTest {
    ...
    void sumsTotalPointsAcrossThreeMapsWithDifferentPerMapScores() {
        ...
        MapScore mapA = new MapScore(20, 45, 6, Duration.ofSeconds(50), MedalTier.GOLD);
        MapScore mapB = new MapScore(30, 60, 3, Duration.ofSeconds(20), MedalTier.DIAMOND);
        MapScore mapC = new MapScore(10, 15, 10, Duration.ofSeconds(80), MedalTier.BRONZE);
    ...
    void aDnfMapContributesItsRingPointsButNotItsTimeAndDoesNotCountTowardMapsFinished() {
        ...
        MapScore finishedFirst = new MapScore(20, 45, 0, Duration.ofSeconds(40), MedalTier.GOLD);
        MapScore dnf = new MapScore(10, 0, 0, Duration.ofSeconds(1), MedalTier.DNF);
        MapScore finishedLast = new MapScore(30, 60, 0, Duration.ofSeconds(25), MedalTier.DIAMOND);
    ...
    void aCupWhereEveryMapIsDnfHasZeroMapsFinishedAndNoBestTime() {
        MapScore dnf1 = new MapScore(10, 0, 0, Duration.ofSeconds(5), MedalTier.DNF);
        MapScore dnf2 = new MapScore(20, 0, 0, Duration.ofSeconds(3), MedalTier.DNF);
        MapScore dnf3 = new MapScore(0, 0, 0, Duration.ofSeconds(9), MedalTier.DNF);
